                ...
                <div class="col-md-10 offset-md-1 col-lg-3 offset-lg-0">
                    <div class="profile-sidebar">
                        ...
                        <div class="widget dashboard-links">
                            <ul>
                                <li><a class="my-1 d-inline-block" href="<?= ROOT ?>/cats/list">My Cats</a></li>
                                <li><a class="my-1 d-inline-block" href="<?= ROOT ?>/user-shows">My Shows <span>(5)</span></a></li>
                                <li><a class="my-1 d-inline-block" href="<?= ROOT ?>/user-awards">My Awards <span>(3)</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="widget personal-info">
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <!-- Submit button -->
                                    <button type="submit" onclick="save_profile(event)" class="btn btn-transparent shadow-sm">Save My Changes</button>
                                </form>
                                <!-- FORM END -->
